...
|文件类型|路径|文件名|
|-|-|-|
|Hex|....\Makecode 教程\Microbit 基础课程\第1课闪烁的心\程序|闪烁的心.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex file|..\Makecode 教程\Microbit 基础课程\第2课LED点阵中单个LED显示\程序|LED点阵中单个LED显示.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第3课 5 x 5 LED点阵图案显示.docx\程序|5 x 5 LED点阵图案显示-1.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex file|Makecode 教程\Microbit 基础课程\第3课 5 x 5 LED点阵图案显示.docx\程序|5 x 5 LED点阵图案显示-2.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第4课可编程按键\程序|可编程按键-1.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex file|Makecode 教程\Microbit 基础课程\第4课microbit的可编程按键\程序|可编程按键-2.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第5课学习测温度\程序|学习测温-1.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第5课学习测温度\程序|学习测温-2.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第6课地磁传感器\程序|地磁传感器-1.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第6课地磁传感器\程序|地磁传感器-2.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第7课加速度传感器\程序|加速度传感器-1.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|教程\Makecode 教程\Microbit 基础课程\第7课加速度传感器\程序|加速度传感-2.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第8课光照强度检测\程序|光照强度检测.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第9课扬声器\程序|扬声器.hex|
...
（2）点击“音乐”栏，找到并拖出指令方块“播放声音咯咯声值到结束”放入“”指令方块中，再从“基础”栏中找到并拖出指令方块“暂停(ms) 100”放入“无限循环”指令方块中，将100改成1000。
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第10课触摸感应logo\程序|触摸感应logo.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第11课麦克风\程序|麦克风-1.hex|
...
|文件类型|路径|文件名|
|-|-|-|
|Hex|Makecode 教程\Microbit 基础课程\第11课麦克风\程序|麦克风-2.hex|
